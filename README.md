...
- `git clone https://github.com/Naledi-Dikgale/decode-a-morse-code.git`
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/decode-a-morse-code/issues).
